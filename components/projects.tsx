...
function Projects() {
    ...
    return <div className='h-[100vh] flex flex-nowrap overflow-y-scroll overflow-x-hidden bg-light_background'>
        <div className=''>
            <div ref={panelsContainer} className='flex flex-nowrap h-[100vh] w-[210vw] relative'>
