...
function Projects() {
    ...
    return <div className='h-[210vh] flex flex-nowrap overflow-y-hidden overflow-x-hidden bg-light_background'>
        <div className=''>
            <div ref={panelsContainer} className='flex flex-nowrap h-[210vh] w-[210vw] relative'>
