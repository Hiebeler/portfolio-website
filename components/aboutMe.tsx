...
function AboutMe() {
    ...
    return <div className='bg-dark_background min-h-screen relative flex-col flex'>
        ...
        <div className='flex-row flex-wrap lg:hidden flex sm:pl-20 pb-20 sm:pr-20 pl-10 pr-10 space-y-10'>
            <div className='basis-full sm:basis-1/2 relative rotate-[4deg] min-h-[200px] flex-row flex justify-center mt-10'>
                <div className='basis-10/12 relative'>
                    <Image src="/images/about-me/eurosafEm.webp" alt="Sailing Image" layout='fill' objectFit='contain' />
                </div>
            </div>
            <div className='basis-full sm:basis-1/2 relative rotate-[-2deg] min-h-[200px] flex-row flex justify-center'>
                <div className='basis-10/12 relative'>
                    <Image src="/images/about-me/29er.webp" alt="Sailing Image" layout='fill' objectFit='contain' />

                </div>
            </div>
            <div className='basis-full sm:basis-1/2 relative rotate-[1deg] min-h-[200px] flex-row flex justify-center'>
                <div className='basis-10/12 relative'>
                    <Image src="/images/about-me/skeeta.webp" alt="Sailing Image" layout='fill' objectFit='contain' />
                </div>
            </div>
            <div className='basis-full sm:basis-1/2 relative rotate-[-3deg] min-h-[200px] flex-row flex justify-center'>
                <div className='basis-10/12 relative'>
                    <Image src="/images/about-me/biking.webp" alt="Sailing Image" layout='fill' objectFit='contain' />
